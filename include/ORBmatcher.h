...
public:
    ...
    int SearchByProjection(Frame &CurrentFrame, const Frame &LastFrame, const float th, const bool bMono, std::string logPath);
	...
	int SearchByBoW(KeyFrame *pKFini, KeyFrame *pKFcur, std::vector<int> &mvIniMatches);
