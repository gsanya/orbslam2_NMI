...
public:
	...
	void SetNMIRelocalized(bool NMIRelocalized);
	bool GetNMIRelocalized();

	void SetNMIFailed(bool NMIFailed);
	bool GetNMIFailed();	
...
public:
	...
	std::vector<cv::Mat> mvPreviousPoses;
