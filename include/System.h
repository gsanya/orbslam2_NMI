...
public:
    ...
    System(const string &strVocFile, const string &strSettingsFile, const eSensor sensor, NmiObjects *myObjectsPar, const bool bUseViewer = true);
	...
	void SaveFullTrajectory(const string &filename);
